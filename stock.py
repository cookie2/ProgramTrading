...
class VirtualStockAccount():
    ...
    def __init__(self, email, password, order, wait_time=1):
    ...
    def Financing_Buy(self, sid, quantity, price=None):
    ...
    def Financing_Sell(self, sid, quantity, price=None):
    ...
    def Margin_Buy(self, sid, quantity, price=None):
    ...
    def Margin_Sell(self, sid, quantity, price=None):
